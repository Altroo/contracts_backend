...
ST_TX = {
    "fr": {
        ...
        "fait_a": "Fait à",
        "le": "le",
        "en_exemplaires": "en deux (02) exemplaires originaux, un pour chaque partie.",
        ...
        "objet_intro": (
            "Par le présent contrat, l'Entrepreneur Principal confie au "
            "Sous-Traitant, qui accepte, l'exécution des travaux suivants, "
            "en application de l'article 723 du Dahir formant Code des "
        ...
        "docs_list": [
            ...
            "Les DTU et règles de l'art en vigueur",
        ],
        ...
        "prix_delai_paiement": "Délai de paiement : {days} jours à compter de la réception de la facture.",
        "prix_avance": "4.3 — Avance forfaitaire",
        "prix_avance_text": "Une avance forfaitaire de {pct}% du montant HT, soit {amount}, sera versée au Sous-Traitant à la signature du contrat. Cette avance sera déduite proportionnellement sur chaque situation de travaux.",
        "prix_retenue": "4.4 — Retenue de garantie",
        "prix_retenue_text": "Une retenue de garantie de {pct}% sera prélevée sur chaque situation de travaux. Elle sera libérée à la réception définitive des travaux, déduction faite des réserves non levées.",
        "prix_supplementaires": "4.5 — Travaux supplémentaires",
        "prix_supplementaires_text": "Tout travail non prévu au présent contrat devra faire l'objet d'un ordre de service écrit de l'EP, accompagné d'un devis accepté par les deux parties. Aucun travail supplémentaire ne sera rémunéré sans accord préalable écrit.",
        # Article 5 – Délais
        "art_delais": "DÉLAIS D'EXÉCUTION",
        "delais_global": "5.1 — Délai global",
        "delais_global_text": "Le délai global d'exécution des travaux est fixé à {val} {unit} à compter de la date de l'ordre de service de démarrage.",
        "delais_planning": "5.2 — Planning",
        "delais_planning_text": "Le Sous-Traitant s'engage à respecter le planning détaillé annexé au présent contrat. Toute modification du planning devra être validée par écrit par l'EP.",
        "delais_penalites": "5.3 — Pénalités de retard",
        "delais_penalites_text": "En cas de retard non justifié, des pénalités de {taux}‰ (pour mille) du montant HT par jour calendaire de retard seront appliquées, plafonnées à {plafond}% du montant total HT du marché.",
        "delais_resiliation": "5.4 — Résiliation pour dépassement",
        "delais_resiliation_text": "Au-delà du plafond de pénalités, l'EP se réserve le droit de résilier le contrat aux torts du Sous-Traitant, conformément à l'Article 11.",
        ...
        "oblig_generales_list": [
            "Exécuter les travaux conformément aux plans, au CCTP et aux règles de l'art",
            "Fournir la main-d'œuvre qualifiée, le matériel et les matériaux nécessaires",
            "Respecter scrupuleusement le planning d'exécution validé",
            "Assurer la coordination avec les autres corps d'état sur le chantier",
            "Maintenir le chantier propre et évacuer les gravats régulièrement",
            "Participer aux réunions de chantier hebdomadaires",
            "Signaler immédiatement tout problème technique ou retard prévisible",
            "Fournir les situations de travaux mensuelles pour établissement des factures",
            "Respecter les dispositions du Code du Travail marocain pour son personnel",
        ],
        ...
        "oblig_ep_list": [
            "Fournir les plans d'exécution validés « Bon Pour Exécution » (BPE) dans les délais",
            "Assurer la coordination générale entre les différents lots et intervenants",
            "Garantir l'accès au chantier et aux zones de travail du Sous-Traitant",
            "Procéder au paiement dans les délais contractuels sur présentation des situations de travaux validées",
            "Désigner un interlocuteur unique (conducteur de travaux) pour le suivi du lot",
            "Informer le Sous-Traitant de toute modification de programme ou de planning",
            "Mettre à disposition les espaces de stockage nécessaires sur le chantier",
        ],
        # Article 8 – Assurances
        "art_assurances": "ASSURANCES",
        "assurances_intro": "Le Sous-Traitant s'engage à souscrire et maintenir en vigueur pendant toute la durée des travaux les assurances suivantes :",
        "assurances_rules": [
            "Les attestations d'assurance devront être fournies avant le démarrage des travaux.",
            "Toute interruption ou résiliation de couverture d'assurance devra être signalée immédiatement à l'EP.",
            "Les montants de couverture devront être adaptés à la nature et à l'importance des travaux.",
            "Le Sous-Traitant reste seul responsable de tout sinistre survenant de son fait, même en présence d'une assurance TRC.",
        ],
        ...
        "reception_definitive_text": "La réception définitive est prononcée à l'expiration du délai de garantie, après constatation de la levée de toutes les réserves et du bon comportement des ouvrages.",
        "reception_decennale": "9.4 — Garantie décennale",
        "reception_decennale_text": "Conformément aux articles 769 et 770 du D.O.C., le Sous-Traitant est tenu de la garantie décennale pour les ouvrages de gros œuvre et les éléments d'équipement indissociables, pour une durée de {months} mois à compter de la réception définitive.",
        # Article 10 – Responsabilité
        "art_responsabilite": "RESPONSABILITÉ ET GARANTIES",
        "resp_resultat": "10.1 — Le Sous-Traitant est tenu d'une obligation de résultat quant à la qualité, la conformité et la solidité des ouvrages exécutés.",
        ...
        "resp_defaillance": "10.4 — En cas de défaillance constatée, l'EP adressera une mise en demeure par lettre recommandée avec accusé de réception. Passé un délai de {days} jours sans réponse satisfaisante, l'EP pourra prendre toutes mesures nécessaires aux frais du Sous-Traitant.",
        # Article 11 – Résiliation
        "art_resiliation": "RÉSILIATION",
        "resil_faute": "11.1 — Résiliation pour faute",
        "resil_faute_intro": "L'EP pourra résilier le contrat de plein droit, par lettre recommandée avec accusé de réception, dans les cas suivants :",
        "resil_faute_list": [
            "Abandon du chantier pendant plus de 15 jours consécutifs",
            "Retard dépassant le plafond des pénalités contractuelles",
            "Non-respect répété des règles de sécurité malgré mise en demeure",
            "Liquidation judiciaire ou insolvabilité avérée du Sous-Traitant",
            "Sous-traitance non autorisée (en cascade)",
            "Défaut d'assurance ou de couverture sociale",
            "Malfaçons graves et répétées non corrigées après mise en demeure",
        ],
        "resil_convenance": "11.2 — Résiliation pour convenance",
        "resil_convenance_text": "L'EP peut résilier le contrat pour convenance moyennant un préavis écrit de 15 jours. Dans ce cas, seuls les travaux réalisés et acceptés seront payés.",
        "resil_consequences": "11.3 — Conséquences",
        "resil_consequences_text": "En cas de résiliation, un état contradictoire des lieux sera dressé. Le Sous-Traitant devra évacuer le chantier dans un délai de 10 jours et restituer les documents et matériels de l'EP.",
        # Article 12 – HSE
        "art_hse": "HYGIÈNE, SÉCURITÉ ET ENVIRONNEMENT",
        "hse_list": [
            "12.1 — Le Sous-Traitant s'engage à respecter la réglementation en vigueur en matière d'hygiène et de sécurité du travail, notamment la loi 65-99 relative au Code du Travail.",
            "12.2 — Il fournira à ses ouvriers les Équipements de Protection Individuelle (EPI) adaptés : casques, gants, chaussures de sécurité, harnais, lunettes, etc.",
            "12.3 — L'emploi de mineurs de moins de 18 ans est strictement interdit sur le chantier.",
            "12.4 — Tout accident de travail devra être déclaré dans les 48 heures conformément à la législation marocaine.",
            "12.5 — Le Sous-Traitant désignera un responsable sécurité sur le chantier.",
        ],
        # Optional clauses
        "clause_confid": "CONFIDENTIALITÉ",
        "clause_confid_text": "Le Sous-Traitant s'engage à garder strictement confidentiels tous les documents, informations et données techniques relatifs au projet. Cette obligation perdure pendant toute la durée du contrat et pendant 3 ans après son terme. En cas de violation, une pénalité forfaitaire de 20% du montant HT du marché sera exigible, sans préjudice de dommages et intérêts complémentaires.",
        "clause_non_conc": "NON-CONCURRENCE",
        "clause_non_conc_text": "Le Sous-Traitant s'engage, pendant la durée du contrat et 12 mois après son terme, à ne pas intervenir directement ou indirectement sur un projet concurrent dans un rayon de 20 km du chantier objet du présent contrat. En cas de violation, une pénalité forfaitaire de 30% du montant HT du marché sera exigible.",
        "clause_non_deb": "NON-DÉBAUCHAGE",
        "clause_non_deb_text": "Le Sous-Traitant s'engage à ne pas débaucher, directement ou indirectement, le personnel de l'EP pendant la durée du contrat et 12 mois après son terme. En cas de violation, une indemnité forfaitaire égale à 12 mois de salaire brut de la personne concernée sera due.",
        "clause_cascade": "INTERDICTION DE SOUS-TRAITANCE EN CASCADE",
        "clause_cascade_text": "Le Sous-Traitant ne peut en aucun cas sous-traiter tout ou partie des travaux objet du présent contrat sans l'accord écrit préalable de l'Entrepreneur Principal. Toute sous-traitance en cascade non autorisée constitue un motif de résiliation immédiate du contrat aux torts exclusifs du Sous-Traitant.",
        "clause_enviro": "CLAUSE ENVIRONNEMENTALE",
        "clause_enviro_text": "Le Sous-Traitant s'engage à respecter la législation environnementale en vigueur (Loi 11-03 relative à la protection de l'environnement). Il devra assurer une gestion responsable des déchets de chantier, limiter les nuisances sonores et utiliser des matériaux conformes aux normes environnementales lorsque disponibles.",
        "clause_pi": "PROPRIÉTÉ INTELLECTUELLE",
        "clause_pi_text": "Tous les plans, études, dessins et documents produits par le Sous-Traitant dans le cadre du présent contrat deviennent la propriété de l'Entrepreneur Principal dès leur remise.",
        "clause_exclus": "EXCLUSIVITÉ",
        "clause_exclus_text": "Pendant la durée des travaux, le Sous-Traitant accorde la priorité au chantier objet du présent contrat et s'engage à ne pas accepter de chantier concurrent pouvant affecter la bonne exécution des travaux.",
        "clause_revision": "RÉVISION DE PRIX",
        "clause_revision_text": "En cas de variation significative des prix des matériaux (supérieure à 15%), les parties pourront procéder à une renégociation du prix. La révision ne pourra être appliquée qu'une seule fois et devra faire l'objet d'un avenant signé par les deux parties.",
        # Trailing articles
        "art_litiges": "RÈGLEMENT DES LITIGES",
        "litiges_mediation": "En cas de différend, les parties s'engagent à rechercher une solution amiable par voie de médiation dans un délai de {days} jours avant toute action judiciaire.",
        "litiges_tribunal": "À défaut de résolution amiable, tout litige sera soumis à la compétence exclusive du Tribunal de Commerce de Tanger.",
        "art_force_majeure": "FORCE MAJEURE",
        "force_majeure_text": (
            "Conformément aux articles 268 et 269 du D.O.C., aucune partie ne sera tenue responsable "
            "d'un manquement à ses obligations contractuelles résultant d'un événement de force majeure. "
            "La partie affectée devra notifier l'autre partie dans un délai de 5 jours. Les délais "
            "d'exécution seront prorogés d'une durée égale à celle de l'empêchement. Si la force majeure "
            "perdure au-delà de 90 jours, chaque partie pourra résilier le contrat sans indemnité."
        ),
        "art_dispositions": "DISPOSITIONS GÉNÉRALES ET FINALES",
        "dispositions_items": [
            "Droit applicable : Le présent contrat est régi par le droit marocain, notamment le D.O.C. et le Code de Commerce.",
            "Intégralité : Le présent contrat constitue l'intégralité de l'accord entre les parties et annule tout accord antérieur.",
            "Modification : Toute modification au présent contrat devra faire l'objet d'un avenant écrit signé par les deux parties.",
            "Nullité partielle : Si une clause du présent contrat était déclarée nulle, les autres clauses resteraient en vigueur.",
            "Notifications : Toute notification sera faite par LRAR à l'adresse des sièges sociaux mentionnés ci-dessus.",
            "Élection de domicile : Les parties élisent domicile à leurs sièges sociaux respectifs.",
        ],
        # Annexe
        "annexe_title": "ANNEXE — PIÈCES JOINTES",
        "annexe_items": [
    ...
    "en": {
        ...
        "fait_a": "Done in",
        "le": "on",
        "en_exemplaires": "in two (02) original copies, one for each party.",
        ...
        "objet_intro": (
            "By this contract, the Principal Contractor entrusts the Subcontractor, "
            "who accepts, with the execution of the following works, in application "
            "of Article 723 of the Dahir forming the Code of Obligations and Contracts (D.O.C.):"
        ),
        ...
        "docs_list": [
            ...
            "Applicable DTU and rules of the trade",
        ],
        # Article 4
        ...
        "prix_delai_paiement": "Payment period: {days} days from receipt of the invoice.",
        "prix_avance": "4.3 — Advance payment",
        "prix_avance_text": "An advance payment of {pct}% of the amount excl. tax, i.e. {amount}, shall be paid to the Subcontractor upon signing the contract. This advance shall be deducted proportionally from each progress claim.",
        "prix_retenue": "4.4 — Retention money",
        "prix_retenue_text": "A retention of {pct}% shall be withheld from each progress claim. It shall be released upon final acceptance of the works, less any outstanding defects.",
        "prix_supplementaires": "4.5 — Additional works",
        "prix_supplementaires_text": "Any work not provided for in this contract shall require a written service order from the PC, accompanied by a quotation accepted by both parties. No additional work shall be paid for without prior written agreement.",
        # Article 5
        "art_delais": "EXECUTION DEADLINES",
        "delais_global": "5.1 — Overall deadline",
        "delais_global_text": "The overall deadline for execution of the works is set at {val} {unit} from the date of the commencement service order.",
        "delais_planning": "5.2 — Schedule",
        "delais_planning_text": "The Subcontractor undertakes to comply with the detailed schedule annexed to this contract. Any modification to the schedule shall be approved in writing by the PC.",
        "delais_penalites": "5.3 — Delay penalties",
        "delais_penalites_text": "In the event of unjustified delay, penalties of {taux}‰ (per mille) of the HT amount per calendar day of delay shall apply, capped at {plafond}% of the total HT contract amount.",
        "delais_resiliation": "5.4 — Termination for exceeding cap",
        "delais_resiliation_text": "Beyond the penalty cap, the PC reserves the right to terminate the contract at the Subcontractor's fault, in accordance with Article 11.",
        # Article 6
        "art_obligations_st": "SUBCONTRACTOR'S OBLIGATIONS",
        "oblig_generales": "6.1 — General obligations",
        "oblig_generales_list": [
            "Execute works in accordance with plans, CCTP and rules of the trade",
            "Provide the qualified labour, equipment and materials required",
            "Strictly comply with the approved execution schedule",
            "Ensure coordination with other trades on site",
            "Keep the site clean and regularly remove rubble",
            "Attend weekly site meetings",
            "Immediately report any technical problem or foreseeable delay",
            "Provide monthly progress claims for invoicing",
            "Comply with the Moroccan Labour Code provisions for its personnel",
        ],
        "oblig_specifiques": "6.2 — Trade-specific obligations",
        # Article 7
        "art_obligations_ep": "PRINCIPAL CONTRACTOR'S OBLIGATIONS",
        "oblig_ep_list": [
            'Provide validated "Approved For Execution" (BPE) plans on time',
            "Ensure overall coordination between the various trades and stakeholders",
            "Guarantee access to the site and the Subcontractor's work areas",
            "Make payment within contractual deadlines upon presentation of validated progress claims",
            "Appoint a single point of contact (site supervisor) for trade monitoring",
            "Inform the Subcontractor of any programme or schedule changes",
            "Make available the necessary storage space on site",
        ],
        # Article 8
        "art_assurances": "INSURANCE",
        "assurances_intro": "The Subcontractor undertakes to take out and maintain throughout the works the following insurance:",
        "assurances_rules": [
            "Insurance certificates must be provided before the works commence.",
            "Any interruption or cancellation of insurance cover must be reported immediately to the PC.",
            "Coverage amounts must be appropriate to the nature and scale of the works.",
            "The Subcontractor remains solely liable for any claim arising from its actions, even where TRC insurance is in place.",
        ],
        ...
        "reception_definitive_text": "Final acceptance is pronounced at the expiry of the warranty period, after verification that all defects have been remedied and the works are performing satisfactorily.",
        "reception_decennale": "9.4 — Ten-year warranty",
        "reception_decennale_text": "In accordance with Articles 769 and 770 of the D.O.C., the Subcontractor is bound by the ten-year warranty for structural works and indissociable building elements, for a period of {months} months from final acceptance.",
        # Article 10
        "art_responsabilite": "LIABILITY AND WARRANTIES",
        "resp_resultat": "10.1 — The Subcontractor is bound by an obligation of result regarding the quality, conformity and soundness of the works executed.",
        ...
        "resp_defaillance": "10.4 — In the event of established failure, the PC shall send a formal notice by registered letter with acknowledgement of receipt. After a period of {days} days without a satisfactory response, the PC may take all necessary measures at the Subcontractor's expense.",
        # Article 11
        "art_resiliation": "TERMINATION",
        "resil_faute": "11.1 — Termination for fault",
        "resil_faute_intro": "The PC may terminate the contract as of right, by registered letter with acknowledgement of receipt, in the following cases:",
        "resil_faute_list": [
            "Abandonment of the site for more than 15 consecutive days",
            "Delay exceeding the contractual penalty cap",
            "Repeated failure to comply with safety rules despite formal notice",
            "Judicial liquidation or proven insolvency of the Subcontractor",
            "Unauthorised sub-subcontracting (cascade)",
            "Lack of insurance or social security coverage",
            "Serious and repeated defects not corrected after formal notice",
        ],
        "resil_convenance": "11.2 — Termination for convenience",
        "resil_convenance_text": "The PC may terminate the contract for convenience with 15 days' written notice. In this case, only works carried out and accepted shall be paid for.",
        "resil_consequences": "11.3 — Consequences",
        "resil_consequences_text": "In the event of termination, a joint site inspection shall be carried out. The Subcontractor must vacate the site within 10 days and return all PC documents and equipment.",
        # Article 12
        "art_hse": "HEALTH, SAFETY AND ENVIRONMENT",
        "hse_list": [
            "12.1 — The Subcontractor undertakes to comply with applicable health and safety regulations, particularly Law 65-99 relating to the Labour Code.",
            "12.2 — It shall provide its workers with appropriate Personal Protective Equipment (PPE): hard hats, gloves, safety boots, harnesses, goggles, etc.",
            "12.3 — The employment of minors under 18 is strictly prohibited on site.",
            "12.4 — Any work accident must be reported within 48 hours in accordance with Moroccan legislation.",
            "12.5 — The Subcontractor shall appoint a safety officer on site.",
        ],
        # Optional clauses
        "clause_confid": "CONFIDENTIALITY",
        "clause_confid_text": "The Subcontractor undertakes to keep strictly confidential all documents, information and technical data relating to the project. This obligation continues throughout the contract and for 3 years after its termination. In the event of breach, a lump-sum penalty of 20% of the HT contract amount shall be due, without prejudice to additional damages.",
        "clause_non_conc": "NON-COMPETITION",
        "clause_non_conc_text": "The Subcontractor undertakes, during the contract and for 12 months after its termination, not to work directly or indirectly on a competing project within a 20 km radius of the site covered by this contract. In the event of breach, a lump-sum penalty of 30% of the HT contract amount shall be due.",
        "clause_non_deb": "NON-SOLICITATION",
        "clause_non_deb_text": "The Subcontractor undertakes not to solicit, directly or indirectly, the PC's personnel during the contract and for 12 months after its termination. In the event of breach, a lump-sum indemnity equal to 12 months' gross salary of the person concerned shall be due.",
        "clause_cascade": "PROHIBITION OF CASCADE SUBCONTRACTING",
        "clause_cascade_text": "The Subcontractor may under no circumstances subcontract all or part of the works covered by this contract without the prior written consent of the Principal Contractor. Any unauthorised cascade subcontracting shall constitute grounds for immediate termination of the contract at the sole fault of the Subcontractor.",
        "clause_enviro": "ENVIRONMENTAL CLAUSE",
        "clause_enviro_text": "The Subcontractor undertakes to comply with applicable environmental legislation (Law 11-03 on environmental protection). It shall ensure responsible management of site waste, limit noise pollution and use materials compliant with environmental standards where available.",
        "clause_pi": "INTELLECTUAL PROPERTY",
        "clause_pi_text": "All plans, studies, drawings and documents produced by the Subcontractor in the course of this contract shall become the property of the Principal Contractor upon delivery.",
        "clause_exclus": "EXCLUSIVITY",
        "clause_exclus_text": "During the works, the Subcontractor shall give priority to the site covered by this contract and undertakes not to accept any competing site that could affect the proper execution of the works.",
        "clause_revision": "PRICE REVISION",
        "clause_revision_text": "In the event of a significant change in material prices (greater than 15%), the parties may renegotiate the price. The revision may only be applied once and must be the subject of an amendment signed by both parties.",
        # Trailing articles
        "art_litiges": "DISPUTE RESOLUTION",
        "litiges_mediation": "In the event of a dispute, the parties undertake to seek an amicable solution by mediation within {days} days before any legal action.",
        "litiges_tribunal": "Failing amicable resolution, any dispute shall be subject to the exclusive jurisdiction of the Commercial Court of Tangier.",
        "art_force_majeure": "FORCE MAJEURE",
        "force_majeure_text": (
            "In accordance with Articles 268 and 269 of the D.O.C., neither party shall be held liable "
            "for a failure to fulfil its contractual obligations resulting from a force majeure event. "
            "The affected party must notify the other party within 5 days. Execution deadlines shall be "
            "extended by a period equal to that of the impediment. If the force majeure event continues "
            "beyond 90 days, either party may terminate the contract without compensation."
        ),
        "art_dispositions": "GENERAL AND FINAL PROVISIONS",
        "dispositions_items": [
            "Applicable law: This contract is governed by Moroccan law, in particular the D.O.C. and the Commercial Code.",
            "Entire agreement: This contract constitutes the entire agreement between the parties and supersedes all prior agreements.",
            "Amendment: Any amendment to this contract must be made by a written addendum signed by both parties.",
            "Severability: If any clause of this contract is declared null, the remaining clauses shall remain in force.",
            "Notices: All notices shall be sent by registered letter with acknowledgement of receipt to the registered offices mentioned above.",
            "Elected domicile: The parties elect domicile at their respective registered offices.",
        ],
        # Annexe
        "annexe_title": "ANNEX — SUPPORTING DOCUMENTS",
        "annexe_items": [
