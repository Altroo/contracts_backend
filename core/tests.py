...
def make_user(is_staff=False, can_view_flag=True, can_print_flag=True,
              can_create_flag=False, can_edit_flag=False, can_delete_flag=False):
...
class TestCorePermissionsWithRealUser:
    ...
    def test_user_with_create_permission(self):
        ...
        user = CustomUser.objects.create_user(
            email="createperm@test.com", password="pass",
            is_staff=False, can_create=True
        )
        assert can_create(user) is True
        assert can_update(user) is False
    ...
    def test_user_with_all_permissions(self):
        ...
        user = CustomUser.objects.create_user(
            email="allperms@test.com", password="pass",
            is_staff=False, can_view=True, can_print=True,
