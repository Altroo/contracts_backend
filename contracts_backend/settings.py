...
WSGI_APPLICATION = "contracts_backend.wsgi.application"
...
REST_FRAMEWORK = dict(
    ...
    EXCEPTION_HANDLER="contracts_backend.utils.api_exception_handler",
...
REST_AUTH = {
    ...
    "JWT_AUTH_COOKIE": "contracts-jwt-access",
    "JWT_AUTH_REFRESH_COOKIE": "contracts-jwt-refresh",
    "TOKEN_MODEL": None,
...
EBH_SSO_APP_SLUG = config("EBH_SSO_APP_SLUG", default="contracts")
