...
class TestCustomUserModel:
    ...
    def test_default_permission_flags(self):
        user = CustomUser.objects.create_user(email="flags@test.com", password="pass")
...
class TestCreateAccountSerializerExtra:
    ...
    def test_process_image_field_file_exception(self):
        ...
        with pytest.raises(
            ...
            match="T\u00e9l\u00e9chargement de fichier invalide|Invalid file upload",
        ):
            CreateAccountSerializer._process_image_field(
...
class TestUserPatchSerializer:
    ...
    def test_update_permission_flags(self):
        """Updating permission boolean fields works correctly."""
        ...
        assert updated.can_print is True
